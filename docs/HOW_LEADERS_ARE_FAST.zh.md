# How the top qr_v2 submissions are fast — POST-MORTEM on the real top-3 code (中文版)

> **English version: [`HOW_LEADERS_ARE_FAST.md`](HOW_LEADERS_ARE_FAST.md).** This is the original
> Chinese draft, kept verbatim.
...
> about what the code does, not a claim about anyone's intent. Index + provenance: `docs/leader_top3/README.md`.
>
