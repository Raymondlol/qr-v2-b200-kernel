...
if _HAS_TRITON:
    @triton.autotune(
        configs=[
            ...
            triton.Config({'BM': 256, 'BN': 64, 'BK': 32}, num_warps=8, num_stages=4),
            triton.Config({'BM': 128, 'BN': 64, 'BK': 64}, num_warps=8, num_stages=4),
            triton.Config({'BM': 64, 'BN': 128, 'BK': 64}, num_warps=8, num_stages=4),
            triton.Config({'BM': 128, 'BN': 256, 'BK': 64}, num_warps=16, num_stages=3),
            triton.Config({'BM': 256, 'BN': 256, 'BK': 32}, num_warps=16, num_stages=3),
        ],
        key=['M', 'N', 'K'],
    )
    @triton.jit
